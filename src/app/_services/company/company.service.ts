...
export class CompanyService {
  ...
  base_path = 'http://192.168.2.27:3000/companies';
  ...
  getCompanies() {
      return this.http.get('http://192.168.2.27:3000/companies', this.httpOptions);
  }

  getCompany(id) {
    return this.http.get('http://192.168.2.27:3000/companies/' + id, this.httpOptions);
  }

  getAdmin() {
    return this.http.get('http://192.168.2.27:3000/admin', this.httpOptions);
  }
  ...
  company_has_service(item) {
    return this.http
      .post('http://192.168.2.27:3000/company_services', item)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  active_payment(id_company, services_id_service) {
    return this.http
    .put('http://192.168.2.27:3000/company_services/' + id_company, {services_id_service} )
    .pipe(
      catchError(this.handleError)
    );
  }
  ...
  register_comition(amount, date, status, payments_id_payments, users_id_user): Observable<Commission> {
    return this.http
    .post<Commission>('http://192.168.2.27:3000/commission/', {amount, date, status, payments_id_payments, users_id_user})
    .pipe(
      catchError(this.handleError)
    );
  }
  getcompanyHasService(id) {
    return this.http.get('http://192.168.2.27:3000/companies/services/' + id, this.httpOptions);
  }
