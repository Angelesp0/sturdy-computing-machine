...
export class UserService {
  ...
  base_path = 'http://192.168.2.27:3000/users';
  ...
  getUsers() {
      return this.http.get('http://192.168.2.27:3000/users', this.httpOptions);
  }
  getExecutive() {
    return this.http.get('http://192.168.2.27:3000/executive', this.httpOptions);
}

  getUser(id) {
    return this.http.get('http://192.168.2.27:3000/users/' + id, this.httpOptions);
  }
  ...
  login(username: string, password: string) {
    return this.http.post<any>('http://192.168.2.27:3000/auth', { username, password })
        .pipe(
          map(
            user => {
