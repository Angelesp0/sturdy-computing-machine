...
export class JsPDFComponent implements OnInit, OnDestroy
{
  ...
  constructor(
   ...
   pf(download?: any, post?: any): void {
    ...
    doc.text(140, 300, '“LA PRESTADORA”.                                      “EL PRESTATARIO”.');
    doc.text(95, 348, '   ___________________________                              ___________________________');
    doc.addImage(prestador, 'PNG', 140, 300, 100, 50);
    doc.addImage(cliente, 'PNG', 400, 300, 100, 50);
    ...
    doc.text(135, 460, '       TESTIGO				                           TESTIGO');
    doc.text(95, 510, '   ___________________________                              ___________________________');
    doc.addImage(cliente, 'PNG', 140, 460, 100, 50);
    doc.addImage(testigo2, 'PNG', 400, 460, 100, 50);
    doc.text(380, 525, 'MARIO DUARTE FLORES');
    doc.text(95, 540, 'GESTORIA EMPRESARIAL GLOBAL                    GESTORIA EMPRESARIAL GLOBAL');
    doc.text(140, 550, 'SERVICE S.C.                                                       SERVICE S.C.');
  ...
  rif(download?: any, post?: any) {
    ...
    doc.text(95, 338, `PRIMERA.- OBJETO. “LA PRESTADORA” se obliga a facilitar sus servicios profesionales a “EL PRESTATARIO”, en materia de CONTABILIDAD ELECTRÓNICA y servicios relacionados con la misma; siempre y cuando se determinen claramente en cláusula específica como parte de este contrato, declara a continuación que prestará sus servicios exclusivamente por tiempo determinado, del periodo comprendido del  ${date} y hasta  ${endDate}.` , {maxWidth: 455, align: 'justify'});
    ...
    doc.text(140, 452, '“LA PRESTADORA”.                                        “EL PRESTATARIO”.');
    doc.text(95, 500, '   ___________________________                              ___________________________');
    doc.addImage(prestador, 'PNG', 140, 450, 100, 50);
    ...
    doc.addImage(testigo2, 'PNG', 400, 615, 100, 50);
